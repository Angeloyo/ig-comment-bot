...
```
9. There are a lot of chances that you will get errors in the future because instagram changed their web design or because the website is showing differently in your device. Try to find the new path to the elements (Xpath, CSS...) via browser developer tools. I only tested this on a mac.
